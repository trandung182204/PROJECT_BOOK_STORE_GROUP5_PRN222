...
namespace PROJECT_BOOK_STORE_GROUP5_PRN222.Migrations
{
    ...
    [Migration("20251013172140_AddParentIdAndIsDeletedToCategory")]
    partial class AddParentIdAndIsDeletedToCategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PROJECT_BOOK_STORE_GROUP5_PRN222.Models.User", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__users__3213E83F72CD265C");

                    b.HasIndex(new[] { "Email" }, "UQ__users__AB6E6164B9CF8F47")
                        .IsUnique();

                    b.HasIndex(new[] { "Username" }, "UQ__users__F3DBC5721EAD29EB")
                        .IsUnique();
